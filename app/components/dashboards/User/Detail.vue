    ...
    <div class="card p-8">
      <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8">
        ...
        <div class="flex-shrink-0">
          <div class="relative">
            <div class="w-32 h-32 rounded-2xl overflow-hidden border-4 border-gray-100 shadow-medium">
              <img
                :src="item.photo || 'https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg?auto=compress&cs=tinysrgb&w=400'"
                :alt="item.full_name || item.username" class="w-full h-full object-cover" />
            </div>
            <!-- Status Badge -->
            <div class="absolute -bottom-2 -right-2">
              <div class="bg-success-500 text-white text-xs font-medium px-3 py-1 rounded-full shadow-medium">
                Active
              </div>
            </div>
          </div>
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          <p class="text-lg text-gray-600 mb-4">{{ item.role }}</p>
      ...
      <div class="card p-6">
        ...
        <div class="space-y-4">
          <div class="detail-item">
            ...
            <p class="detail-value">{{ item.full_name || item.username }}</p>
          </div>
          <div class="detail-item">
          ...
          <div class="detail-item">
            ...
            <p class="detail-value">{{ item.phone || 'Not provided' }}</p>
          </div>
          <div class="detail-item">
            <label class="detail-label">Department</label>
            <p class="detail-value">{{ item.department || 'Not specified' }}</p>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-4">
          ...
          <div class="detail-item">
            ...
            <div class="flex items-center">
              ...
              <span class="detail-value text-success-600">Active</span>
            </div>
          </div>
          <div class="detail-item">
            <label class="detail-label">Last Login</label>
            <p class="detail-value">{{ formatDate(item.last_login) || 'Never' }}</p>
          </div>
          <div class="detail-item">
