...
<template>
  ...
  >
    <v-card
      class="overflow-hidden h-screen position-relative"
      elevation="0"
      rounded="0"
    >
      <v-progress-linear
        ...
        >
          ...
          <div class="d-flex align-center justify-space-between mb-4">
            <div class="d-flex align-center ga-8 flex-wrap">
                ...
                <v-avatar
                  ...
                  :image="
                    project.pm_str.photo
                      ...
                      : config.public.apiMedia + '/images/profile/user-1.jpg'
                  "
              ...
              <div class="d-flex align-center ga-2">
                ...
                <AvatarGroup :users="project.engineer" :pm="project.pm_str" />
              </div>
            </div>
            <v-chip
              :color="colorByStatus(project.status)"
          ...
          <div class="mb-4">
            ...
            <div class="d-flex flex-column ga-3">
              ...
              <div
                v-if="!(project.finance || project.finances || []).length"
          ...
          <div>
            ...
            <div class="d-flex flex-column ga-3">
              ...
              <div
                v-if="!(project.project_status || []).length"
                class="text-caption text-grey-darken-1 pl-5"
              >
